...
export const portfolioProjects = [
  ...
  },
  {
    ...
    color: '#00CED1', // Cyan (Ghostbusters blue)
  },
  {
    id: 'borderlands',
    title: 'Borderlands',
  ...
  },
  {
    ...
    description: 'Custom illustration (using food) for a poster about brand perceptions',
    alt: 'Food poster',
    date: '2016',
  ...
  },
  {
    id: 'playbook',
    title: 'Playbook',
    description: 'Custom illustration of the Author to help explain the book to the reader',
    date: '2017',
  ...
  },
  {
    ...
    description: 'Branded Experience for a play, with installation, print and digital media',
  ...
  },
  {
    id: 'bourbon-bird',
    title: 'Bourbon & Bird',
    description: 'Brand for a restaurant speacializing in bourbon and chicken wings.',
  ...
  {
    id: 'level-up-buttercup',
    title: 'Level Up Buttercup',
    description: 'Logo for a local Dungeons & Dragons Group. Tshirts, Website, Streaming Frame and Animations',
    date: '2018',
  ...
  },
  {
    ...
    description: 'Custom illustration for a brochure for Cleveland State College',
    date: '2012',
...
// Helper function to get a project by path
export const getProjectByPath = (path) => {
  return portfolioProjects.find((project) => project.path === path);
};
