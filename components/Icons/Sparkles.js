...
const SvgComponent = () => {
  ...
  const Sparkle = styled.path`
    animation: ${(props) => (props.play ? 'confetti 1.5s forwards' : 'none')};
  `;
  ...
  return (
    ...
    >
      <Sparkle
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M11.8205 11.3407L10.5805 8.61292L9.34062 11.3407L6.61279 12.5807L9.34062 13.8206L10.5805 16.5484L11.8205 13.8206L14.5483 12.5807L11.8205 11.3407Z"
        fill="white"
      />
      <Sparkle
        fill-rule="evenodd"
